...
FactoryUtils.injectCode = function(code, id) {
  ...
  // COMENTADO PARA QUE NO PRETTIFIQUE
  //code = pre.textContent;
  //code = PR.prettyPrintOne(code, 'js');

  var guardado=document.getElementById("codigo_guardado").innerHTML;
  if(guardado==""){
  	guardado="// TODO: Assemble JavaScript into code variable.\nvar code = '...;\\n';"
  }
  var code2=code.replace("// TODO: Assemble JavaScript into code variable.\n  var code = '...;\\n';", "<textarea id='codigaso' oninput='guardar_codigo()' style='width: 95%;height: 3em;'>"+guardado+"</textarea>");
  pre.innerHTML = code2;	
};
