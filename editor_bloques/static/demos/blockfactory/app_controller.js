...
// Añado una cuarta para el espacio de trabajo
AppController.WORKSPACE_PROJECT = 'WORKSPACE_PROJECT';
...
AppController.prototype.onTab = function() {
  ...
  if (this.selectedTab == AppController.EXPORTER) {
    ...
    //this.workspaceFactoryController.setBlockLibCategory(categoryXml,  blockTypes);
  }
...
AppController.prototype.assignLibraryClickHandlers = function() {
  var self = this;
//boton mio
  //document.getElementById('generateBlockLibraryButton').addEventListener('click',guardar_bloque());
  ...
  document.getElementById('saveToBlockLibraryButton').addEventListener('click',
      function() {
        ...
        onclickgenerateBlockLibraryButton();
      });
